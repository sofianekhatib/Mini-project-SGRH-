                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        >
                            ...
                            <span className="text-xl font-bold bg-gradient-to-r text-indigo-700 bg-clip-text">
                                SmartLodge
                            </span>
                        </div>
            ...
            <footer className="bg-gray-800 text-white py-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="flex justify-center gap-6 mt-4">
                        <button className="text-gray-400 hover:text-white transition cursor-pointer">Mentions légales</button>
                        <button className="text-gray-400 hover:text-white transition cursor-pointer">Confidentialité</button>
